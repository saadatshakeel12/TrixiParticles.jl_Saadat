...
z_surface = cyl_z_min - factor * 0.001
...
floor_particles = RectangularShape(particle_spacing, (30, 30, num_layers),
                                   (-0.01, -0.01, z_bottom);
                                   density=floor_density)
...
tspan  = (0.0,10*t_fall)    # 3x fall time to see contact + compression
